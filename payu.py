...
#		os.system('clear')
		print("""
		;;;;;;;;;;;;;;;;;;;;;;;;
		; SMS Gratis XXXXXXXXX ;
		;      - DemonZ -      ;
		;;;;;;;;;;;;;;;;;;;;;;;;
		""")
		no=input('[?] Number Target: ')
	...
	def main(self,no,msg):
		...
		if 'SMS Gratis Telah Dikirim' in str(sub):
			print('[+] Succsess to send to',no)
		elif 'Please wait' in str(sub):
			print('[!] wait a while to send the same message')
		else:
			print('[-] failed to send to',no)
